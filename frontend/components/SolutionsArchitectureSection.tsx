        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-6 mb-20">
            ...
            <p className="text-gray-400 text-lg">
              We combine proprietary platforms and custom AI engineering
              to deploy production-grade agentic systems inside
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        ...
                        {/* Voice Agent Demo CTA only under first module */}
                        {index === 0 && (
